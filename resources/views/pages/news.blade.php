...
@section('content')
  ...
  <div class="max-w-[1440px] mx-auto p-8">
    ...
    <div class="h-[500px] w-full rounded-xl overflow-hidden">
      <img 
    ...
    <h6 class="text-5xl font-semibold mt-4 leading-14">
    ...
    <div class="w-full flex justify-between items-center pt-4">
      <div class="flex items-center gap-2 mt-auto">
        <img
          ...
          alt="">
        <p class="font-semibold text-sm sm:text-base">Dimas Pratama</p>
        <div class="h-1 w-1 bg-gray-400 rounded-full"></div>
        <p class="text-sm text-gray-400">4 min read</p>

        <p class="font-semibold ml-4 text-sm sm:text-base">Tech</p>
        <div class="h-1 w-1 bg-gray-400 rounded-full"></div>
        <p class="text-sm text-gray-400">8 min ago</p>
      </div>

      <div class="flex items-center justify-center md:justify-normal gap-3">
        <p>Share :</p>
        <a href="#" aria-label="Instagram" class="text-gray-600 hover:text-gray-700 transition duration-300">
        ...
        <a href="#" aria-label="TikTok" class="text-gray-600 hover:text-gray-700 transition duration-300">
            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 fill-current">
                <title>TikTok</title>
        ...
        <a href="#" aria-label="Twitter / X" class="text-gray-600 hover:text-gray-700 transition duration-300">
            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 fill-current">
                <title>X</title>
